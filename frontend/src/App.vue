    ...
    >
      ...
      >
        <button
          ...
          :title="view !== 'viewer' ? t('app.closeSettingsTitle') : undefined"
          @click="closeSettings"
        >
...
// Esc (or clicking the DocSanctum wordmark) closes the settings/changelog
// view and returns to the document viewer.
function closeSettings() {
  if (view.value !== 'viewer') view.value = 'viewer'
}
onKeyStroke('Escape', closeSettings)
