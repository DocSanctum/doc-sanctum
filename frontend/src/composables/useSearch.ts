...
// The palette's global shortcut handler accepts either modifier (metaKey or
// ctrlKey) regardless of platform, so both are spelled out here rather than
// picking one based on OS — shared by the search button tooltip and the
// palette hint text (App.vue, CommandPalette.vue).
